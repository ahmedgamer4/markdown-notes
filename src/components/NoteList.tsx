      ...
      <Row className='align-items-center mb-4'>
        ...
        <Col xs="auto">
          <Stack direction='horizontal' gap={2}>
            ...
            <Button variant='outline-secondary' onClick={() => setModalOpen(true)}>Edit tag</Button>
          </Stack>
        </Col>
      </Row>
      <Form>
...
function EditTagsModel({ availableTags, show, handleClose, deleteTag, updateTag }: EditTagsModalProps) {
